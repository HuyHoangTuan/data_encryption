...
class Tables:
    ...
    def __init__(self, fs, bitrate):
        ...
        freqband = np.loadtxt('../res/tables/' + thrtable, dtype='float32')
        critband = np.loadtxt('../res/tables/' + crbtable, dtype='uint16')
        ...
        self.scalefactor = np.loadtxt('../res/tables/layer1scalefactors', dtype='float32')
